...
plot.df_p1 <- data.frame(x, y, xend, yend, x_len, y_len, segment_len, nps_region = nps_rec_visits_np_2018_plotly$nps_region_names)

p1 <- plot_ly(plot.df_p1, 
             x = ~x, y = ~y,
             xend = ~xend, yend = ~yend,
             name = ~nps_rec_visits_np_2018_plotly$nps_region_names,
...
plot.df_p2 <- data.frame(x, y, xend, yend, x_len, y_len, segment_len)
